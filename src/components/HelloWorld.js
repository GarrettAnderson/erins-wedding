  ...
  render() {
    return (
      <div id="canvas">
        <MobileNav />
        <TabletDesktopNav />
        <div className="page-divider top-divider" />
        <section className="main-content">
          <section className="image-container">
            <img src={saveTheDateImg} />
          </section>
          ...
          <section className="wedding-invitation">
            <h2>
              Erin and Jesse joyfully request the pleasure of your company as we speak our vows and join in marriage in
              the presence of family and friends.
            </h2>
            <h2>Photography by Emily Karcher Photography, LLC.</h2>
          </section>
        </section>
        <footer>
          <p>Built by Garrett L.G. Anderson</p>
        </footer>
      </div>
    )
  }
